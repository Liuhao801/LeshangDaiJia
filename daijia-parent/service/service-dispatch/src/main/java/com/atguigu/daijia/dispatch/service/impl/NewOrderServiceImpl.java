...
public class NewOrderServiceImpl implements NewOrderService {
    ...
    public Long addAndStartTask(NewOrderTaskVo newOrderTaskVo) {
        ...
        if(orderJob == null) {
            ...
            orderJob.setParameter(JSONUtil.toJsonStr(newOrderTaskVo));
    ...
    public void executeTask(long jobId) {
        ...
        NewOrderTaskVo newOrderTaskVo = JSONUtil.toBean(jsonString, NewOrderTaskVo.class);
        ...
        nearByDriverVoList.forEach(driver -> {
            ...
            if(BooleanUtil.isFalse(isMember)) {
                ...
                stringRedisTemplate.opsForList().leftPush(key,JSONUtil.toJsonStr(newOrderDataVo));
                //过期时间：1分钟
    ...
    public List<NewOrderDataVo> findNewOrderQueueData(Long driverId) {
        ...
        if(size!=null && size > 0) {
            for (int i = 0; i < size; i++) {
                ...
                NewOrderDataVo newOrderDataVo = JSONUtil.toBean(content, NewOrderDataVo.class);
